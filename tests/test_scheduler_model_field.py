...
from kynetic_agents.scheduler import SchedulerJob, SchedulerMixin, _is_valid_model_string
...
class TestLoadSchedulerJobsModel:
    ...
    def test_invalid_model_string_logs_warning_and_falls_back_to_none(
        ...
        app = FakeApp(tmp_home)
        import logging
        with patch.object(logging.getLogger("kynetic_agents.scheduler"), "warning") as mock_warn:
            jobs = app._load_scheduler_jobs()
        assert jobs[0].model is None
