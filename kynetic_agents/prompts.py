...
- Pay attention to which conversation is happening in which channel, and use channel IDs correctly.
...
- **Never edit `.kynetic_agents_builtin_skills/`** — these are read-only system skills managed upstream. For custom skills, use the skill-creator skill. To change system skills, PR the kynetic-agents repo.
