...
```bash
uv run python ./.kynetic_agents_builtin_skills/scripts/memory_dashboard.py
```
...
The `./.kynetic_agents_builtin_skills/scripts/file_frequency_report.py` script looks
