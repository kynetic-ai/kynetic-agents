...
## Maintenance
Read `/.kynetic_agents_builtin_skills/memory/maintenance.md` for instructions for how to
...
disruption, the **onboarding skill** (`/.kynetic_agents_builtin_skills/onboarding/SKILL.md`)
