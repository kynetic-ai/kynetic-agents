...
jobs:
  - name: prediction-review-twice-daily
    ...
    prompt: |
      ...
      `uv run python .kynetic_agents_builtin_skills/scripts/prediction_review_log.py --prediction-datetime ... --is-true ... --comments ...`
...
echo "[kynetic-agents pre-commit] uv/python not found; cannot run scripts/pre_commit.py" >&2
exit 1
"""
